...
global.owner = process.env.OWNER_NUMBER  || '2347061809282' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uMsAXLrC#IjQOHrof0UpkODhUkJ3ztK77uqduoPmiGr2LHEoOezI' ,
